...
class BGCPSettings(PropertyGroup):
    building_width: FloatProperty(name="Width", default=6.0, min=1.0, update=update_building)
    building_depth: FloatProperty(name="Depth", default=4.0, min=1.0, update=update_building)
    floors: IntProperty(name="Floors", default=3, min=1, max=64, update=update_building)
    floor_height: FloatProperty(name="Floor Height", default=2.8, min=1.0, update=update_building)

    roof_style: EnumProperty(name="Roof Style", items=roof_style_items(), default='FLAT', update=update_building)
    roof_height: FloatProperty(name="Roof Height", default=0.35, min=0.05, update=update_building)
    roof_overhang: FloatProperty(name="Roof Overhang", default=0.25, min=0.0, update=update_building)
    ...
    platform_margin: FloatProperty(name="Platform Margin", default=1.25, min=0.0, update=update_building)
    ...
    balustrade_height: FloatProperty(name="Balustrade Height", default=0.48, min=0.05, update=update_building)
    balustrade_post_spacing: FloatProperty(name="Post Spacing", default=0.75, min=0.25, update=update_building)
    bay_count: IntProperty(name="Front Bays", default=7, min=2, max=32, update=update_building)
    ...
    column_height: FloatProperty(name="Column Height", default=3.2, min=0.5, update=update_building)
    main_door_height: FloatProperty(name="Main Door Height", default=2.2, min=0.1, update=update_building)
    lower_roof_height: FloatProperty(name="Lower Roof Height", default=0.85, min=0.05, update=update_building)
    upper_platform_height: FloatProperty(name="Upper Platform Height", default=1.3, min=0.1, update=update_building)
    upper_roof_height: FloatProperty(name="Upper Roof Height", default=1.25, min=0.05, update=update_building)
    roof_curve: FloatProperty(name="Roof Curve", default=0.35, min=0.0, max=1.0, update=update_building)
    roof_line_width: FloatProperty(name="Roof Line Width", default=0.055, min=0.005, update=update_building)
    roof_line_height: FloatProperty(name="Roof Line Height", default=0.045, min=0.001, update=update_building)
    roof_edge_line_width: FloatProperty(name="Roof Edge Line Width", default=0.055, min=0.005, update=update_building)
    roof_edge_line_height: FloatProperty(name="Roof Edge Line Height", default=0.035, min=0.001, update=update_building)
    roof_underside_thickness: FloatProperty(name="Roof Underside Thickness", default=0.08, min=0.001, update=update_building)
    ...
    roof_tile_rib_width: FloatProperty(name="Tile Rib Width", default=0.16, min=0.02, update=update_building)
    roof_tile_gap: FloatProperty(name="Tile Gap", default=0.10, min=0.0, update=update_building)
    roof_tile_rib_height: FloatProperty(name="Tile Rib Height", default=0.07, min=0.01, update=update_building)
    roof_tile_segment_length: FloatProperty(name="Tile Segment Length", default=0.55, min=0.12, update=update_building)
    roof_tile_cap_radius: FloatProperty(name="Tile Cap Radius", default=0.11, min=0.03, update=update_building)
    eave_overhang: FloatProperty(name="Eave Overhang", default=0.95, min=0.0, update=update_building)
