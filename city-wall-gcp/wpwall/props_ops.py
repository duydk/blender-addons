...
class WPWallSettings(PropertyGroup):
    ...
    wall_material: PointerProperty(name="Wall", type=bpy.types.Material, update=lambda self, ctx: trigger_rebuild(ctx))
    ...
    brick_scale: FloatProperty(name="Brick Scale", default=4.0, min=0.1, update=lambda self, ctx: update_brick_material_settings(self, ctx))
    brick_mortar_size: FloatProperty(name="Mortar Size", default=0.02, min=0.001, max=0.25, update=lambda self, ctx: update_brick_material_settings(self, ctx))
    ...
    brick_damage_amount: FloatProperty(name="Damage Amount", default=1.0, min=0.0, max=1.0, update=lambda self, ctx: update_brick_material_settings(self, ctx))
    brick_damage_scale: FloatProperty(name="Damage Scale", default=18.0, min=0.1, update=lambda self, ctx: update_brick_material_settings(self, ctx))
    ...
    brick_top_damage_amount: FloatProperty(name="Top Damage Amount", default=0.0, min=0.0, max=1.0, update=lambda self, ctx: update_brick_material_settings(self, ctx))
    brick_top_damage_scale: FloatProperty(name="Top Damage Scale", default=18.0, min=0.1, update=lambda self, ctx: update_brick_material_settings(self, ctx))
    ...
    brick_tunnel_damage_amount: FloatProperty(name="Tunnel Damage Amount", default=0.0, min=0.0, max=1.0, update=lambda self, ctx: update_brick_material_settings(self, ctx))
    brick_tunnel_damage_scale: FloatProperty(name="Tunnel Damage Scale", default=18.0, min=0.1, update=lambda self, ctx: update_brick_material_settings(self, ctx))
    ...
    brick_stair_top_damage_amount: FloatProperty(name="Stair Top Damage Amount", default=0.0, min=0.0, max=1.0, update=lambda self, ctx: update_brick_material_settings(self, ctx))
    brick_stair_top_damage_scale: FloatProperty(name="Stair Top Damage Scale", default=18.0, min=0.1, update=lambda self, ctx: update_brick_material_settings(self, ctx))
