...
BUILDING_TYPE_SPECS = MappingProxyType(
    {
        ...
        "HALL": BuildingTypeSpec(
            ...
            defaults=_defaults(
                ...
                balustrade_height=0.48,
                balustrade_post_spacing=0.75,
                bay_count=7,
                side_bay_count=2,
                column_radius=0.09,
                column_height=3.2,
                main_door_height=2.2,
                lower_roof_height=0.85,
                upper_platform_height=1.3,
                upper_roof_height=1.25,
                roof_curve=0.35,
                roof_line_width=0.055,
                roof_line_height=0.045,
                roof_edge_line_width=0.055,
                roof_edge_line_height=0.035,
                roof_underside_thickness=0.08,
                roof_underside_z_offset=0.0,
                roof_tiles_enabled=True,
                roof_tile_rib_width=0.16,
                roof_tile_gap=0.10,
                roof_tile_rib_height=0.07,
                roof_tile_segment_length=0.55,
                roof_tile_cap_radius=0.11,
                eave_overhang=0.95,
